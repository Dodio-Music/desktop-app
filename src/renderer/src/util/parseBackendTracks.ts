...
import {PlaylistSongDTO, ReleaseDTO} from "../../../shared/Api";
...
export function playlistTracksToSongEntries(orderedIds: string[], songsMap: Record<string, PlaylistSongDTO>): RemoteSongEntry[] {
